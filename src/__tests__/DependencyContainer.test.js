...
var TestDependency = /** @class */ (function (_super) {
    __extends(TestDependency, _super);
    ...
    TestDependency.prototype.initialize = function () {
        return this.promise;
    };
    TestDependency.prototype.finishInitialization = function () {
        this.resolve();
    };
    return TestDependency;
}(bindable_bloc_1.BaseBloc));
test("DependencyContainer initializes correctly", function () { return __awaiter(void 0, void 0, void 0, function () {
    var testDep, container;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, PromiseUtils_1["default"].wait(100)];
            case 1:
                _a.sent();
                expect(container.isInitializing.value).toBe(false);
                return [2 /*return*/];
