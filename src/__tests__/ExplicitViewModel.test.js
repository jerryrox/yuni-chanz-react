...
var TestVM = /** @class */ (function (_super) {
    ...
    function TestVM() {
        ...
        _this.paramReceiveCount = 0;
        _this.receivedParam = null;
        return _this;
    }
    TestVM.prototype.onShowParam = function (param) {
...
test("ViewModel is shown with correct onShowParam calls", function () {
